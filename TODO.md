...
- [ ] ADR-0002: "Por que database-per-service"
- [ ] ADR-0003: "Por que NATS para mensageria assíncrona"
  📚 Estudar: at-least-once vs exactly-once delivery — por que isso importa pro evento de recebimento de mercadoria
- [ ] ADR-0004: "Kg como unidade canônica de estoque — conversões acontecem na borda"

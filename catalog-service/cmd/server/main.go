...
import (
	...
	"mtv-erp/catalog-service/internal/config"
	"mtv-erp/catalog-service/internal/health"
...
func main() {
	...
	shutdownTracer, err := observability.InitTracer(ctx, "catalog-service")
	if err != nil {
	...
	slog.Info("serviço iniciado", "service", "catalog-service", "env", cfg.Environment, "port", cfg.Port)
